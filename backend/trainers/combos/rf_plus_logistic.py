...
def _ensemble_filename():
    ...
    return f"ensemble_rf_plus_lr_{ts}.json"
...
def train(X_train, y_train, X_val, y_val, config=None):
    ...
    if task != "classification":
        raise ValueError("rf_plus_logistic combo supports classification only")
    ...
    ensemble_meta = {
        "ensemble_name": "Random Forest + Logistic Regression",
        "method": "soft_average",
