...
def _ensemble_filename():
    ...
    return f"ensemble_lr_plus_cnn_{ts}.json"
...
def train(X_train, y_train, X_val, y_val, config=None):
    ...
    if task != "classification":
        raise ValueError("lr_plus_cnn combo supports classification only")
    ...
    combine_time = 0.0  # optional to measure

    ensemble_meta = {
        "ensemble_name": "Logistic Regression + CNN",
        "method": "soft_average",
    ...
    result = {
        "model_name": "Logistic Regression + CNN",
