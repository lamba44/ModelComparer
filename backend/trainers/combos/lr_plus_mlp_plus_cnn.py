...
def _ensemble_filename():
    ...
    return f"ensemble_lr_plus_mlp_plus_cnn_{ts}.json"
...
def train(X_train, y_train, X_val, y_val, config=None):
    ...
    if task != "classification":
        raise ValueError("lr_plus_mlp_plus_cnn combo supports classification only")
    ...
    ensemble_meta = {
        "ensemble_name": "Logistic Regression + MLP + CNN",
        "method": "soft_average",
    ...
    result = {
        "model_name": "Logistic Regression + MLP + CNN",
