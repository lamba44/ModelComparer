...
def _ensemble_filename():
    ...
    return f"ensemble_lr_plus_lstm_{ts}.json"
...
def train(X_train, y_train, X_val, y_val, config=None):
    ...
    if task != "classification":
        raise ValueError("lr_plus_lstm combo supports classification only")
    ...
    ensemble_meta = {
        "ensemble_name": "Logistic Regression + LSTM",
        "method": "soft_average",
    ...
    result = {
        "model_name": "Logistic Regression + LSTM",
